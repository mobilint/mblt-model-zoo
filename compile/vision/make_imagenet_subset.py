...
def make_imagenet_subset(data_dir: str, output_dir: str, subset_size: int, seed: int = 0) -> None:
    ...
    copied = make_calibration_subset("image_classification", data_dir, output_dir, subset_size, seed)
