...
from .configuration_qwen3 import MobilintQwen3Config

logger = logging.get_logger(__name__)

class MobilintQwen3ForCausalLM(MobilintModelMixin, MobilintGenerationMixin):
    config: MobilintQwen3Config
    base_model_prefix = "model"

    def __init__(self, config: MobilintQwen3Config, *args, **kwargs):
