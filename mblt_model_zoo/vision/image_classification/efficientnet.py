...
class EfficientNet_B0(MBLT_Engine):
    def __init__(self, local_model: str = None, model_type: str = "DEFAULT"):
        ...
        model_cfg = EfficientNet_B0_Set.__dict__[model_type].value.model_cfg
        if local_model:
            model_cfg["url"] = local_model
        pre_cfg = EfficientNet_B0_Set.__dict__[model_type].value.pre_cfg
        post_cfg = EfficientNet_B0_Set.__dict__[model_type].value.post_cfg
