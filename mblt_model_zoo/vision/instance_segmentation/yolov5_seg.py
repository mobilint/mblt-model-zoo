...
class YOLOv5mSeg_Set(ModelInfoSet):
    COCO_V1 = ModelInfo(
        model_cfg={
            "url_dict": {
                "aries": {
                    "single": "https://dl.mobilint.com/model/vision/instance_segmentation/yolov5m-seg/aries/single/yolov5m-seg.mxq",
                    "multi": "https://dl.mobilint.com/model/vision/instance_segmentation/yolov5m-seg/aries/multi/yolov5m-seg.mxq",
                    "global": "https://dl.mobilint.com/model/vision/instance_segmentation/yolov5m-seg/aries/global/yolov5m-seg.mxq",
                },
                "regulus": {"single": None},
            },
        },
